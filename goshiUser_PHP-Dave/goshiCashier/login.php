<?php
    ...
    if(isset($_POST['cashierSubmit'])) {
        $username = $_POST['username'];
        $password = $_POST['password'];
        
        $query = "SELECT * FROM accounts WHERE username='$username' AND password='$password' AND accountType='cashier'";
        ...
        if ($numRows == 1) {
            while($id = sqlsrv_fetch_object($stmt)) {
                ...
                header('Location: startTransaction.php');
            }
        }
    }
?>